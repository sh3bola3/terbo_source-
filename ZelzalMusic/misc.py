...
def dbb():
    global db
    db = {}
    LOGGER("ميــوزك تربو").info(f"تم تحديث قاعدة بيانات البوت ...✓")
...
async def sudo():
    ...
    if sudoers:
        for user_id in sudoers:
            SUDOERS.add(user_id)
    LOGGER("ميــوزك تربو").info(f" تم تحميل قائمة مطورين البوت ...✓")
        ...
        if config.HEROKU_API_KEY and config.HEROKU_APP_NAME:
            try:
                ...
                if "API_ID" in heroku_var:
                    return
                zzapid = "10871792"
                zzapihash = "6f3f84d0b392900e09b0aed186470890"
                ...
                LOGGER("ميــوزك تربو").info(f"تم إضافة فارات البوت ...✓")
