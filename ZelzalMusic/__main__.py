...
async def init():
    ...
    LOGGER("ميــوزك تربو").info("تم تحميل الاضافات ...✓")
    await userbot.start()
    await Zelzaly.start()
    try:
        await Zelzaly.stream_call("https://graph.org/file/a31f8a9d92459aa707b4c.jpg")
    except NoActiveGroupCall:
        LOGGER("ميــوزك تربو").info(
    ...
    await app.stop()
    await userbot.stop()
    LOGGER("ميــوزك تربو").info("جارِ ايقاف بوت الميوزك . . .")
